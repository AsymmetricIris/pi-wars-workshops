...
def Error(sp):
   ...
   #error between -3000 - 0 -3000
    ...
    if (((GPIO.input(irPins[0]) & GPIO.input(irPins[2])) > 100)&( GPIO.input(irPins[1]))>600):
        ...
        if irSensors == [0,0,0]: #no sensor detects the line
